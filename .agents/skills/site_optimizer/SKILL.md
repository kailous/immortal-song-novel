...
3. 若是章节海报，先执行 `make compose-poster SRC=... OUT=...`，用 `资源/品牌/插图模板.png` 叠加统一版式。
...
- `../illustration_generator/scripts/apply_poster_template.py`：将 `资源/品牌/插图模板.png` 覆盖到章节插图上，统一成片版式。
